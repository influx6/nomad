...
type VaultConfig struct {
	...
	Enabled *bool `mapstructure:"enabled" hcl:"enabled"`
	...
	Role string `mapstructure:"create_from_role" hcl:"create_from_role"`
	...
	// policies.
	AllowUnauthenticated *bool `mapstructure:"allow_unauthenticated" hcl:"allow_unauthenticated"`
	...
	TaskTokenTTL string `mapstructure:"task_token_ttl" hcl:"task_token_ttl"`
	...
	TLSCaFile string `mapstructure:"ca_file" hcl:"ca_file"`

	// TLSCaFile is the path to a directory of PEM-encoded CA cert files to
	// verify the Vault server SSL certificate.
	TLSCaPath string `mapstructure:"ca_path" hcl:"ca_path"`

	// TLSCertFile is the path to the certificate for Vault communication
	TLSCertFile string `mapstructure:"cert_file" hcl:"cert_file"`

	// TLSKeyFile is the path to the private key for Vault communication
	TLSKeyFile string `mapstructure:"key_file" hcl:"key_file"`

	// TLSSkipVerify enables or disables SSL verification
	TLSSkipVerify *bool `mapstructure:"tls_skip_verify" hcl:"tls_skip_verify"`

	// TLSServerName, if set, is used to set the SNI host when connecting via TLS.
	TLSServerName string `mapstructure:"tls_server_name" hcl:"tls_server_name"`
}
