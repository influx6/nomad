...
type TLSConfig struct {
	...
	EnableHTTP bool `mapstructure:"http" hcl:"http"`

	// EnableRPC enables TLS for RPC and Raft traffic to the Nomad servers
	EnableRPC bool `mapstructure:"rpc" hcl:"rpc"`
	...
	// existing clients.
	VerifyServerHostname bool `mapstructure:"verify_server_hostname" hcl:"verify_server_hostname"`
	...
	RPCUpgradeMode bool `mapstructure:"rpc_upgrade_mode" hcl:"rpc_upgrade_mode"`

	// Verify connections to the HTTPS API
	VerifyHTTPSClient bool `mapstructure:"verify_https_client" hcl:"verify_https_client"`
	...
	// connections
	TLSCipherSuites string `mapstructure:"tls_cipher_suites" hcl:"tls_cipher_suites"`

	// TLSMinVersion is used to set the minimum TLS version used for TLS
	// connections. Should be either "tls10", "tls11", or "tls12".
	TLSMinVersion string `mapstructure:"tls_min_version" hcl:"tls_min_version"`

	// TLSPreferServerCipherSuites controls whether the server selects the
	// client's most preferred ciphersuite, or the server's most preferred
	// ciphersuite. If true then the server's preference, as expressed in
	// the order of elements in CipherSuites, is used.
	TLSPreferServerCipherSuites bool `mapstructure:"tls_prefer_server_cipher_suites" hcl:"tls_prefer_server_cipher_suites"`
}
